...
public class FileTarget {
	...
	/**所有上传该文件的客户端*/
	private Set<FileChatHandlers>currentFileUploaders;
	/**文件上传进度*/
	...
	public FileTarget(FileInfo fileInfo){
		this.currentFileUploaders=new CopyOnWriteArraySet<FileChatHandlers>();
...
//		System.out.println("Create FileTarget successed.: "+fileInfo.getFileId());
	...
	public Set<FileChatHandlers> getCurrentFileUploaders() {
		return currentFileUploaders;
	}
	public void setCurrentFileUploaders(Set<FileChatHandlers> currentFileUploaders) {
	...
	public void addUploader(FileChatHandlers fs){
		this.currentFileUploaders.add(fs);
	}
	public void removeUploader(FileChatHandlers fs){
